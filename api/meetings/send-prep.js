import { buildAgendaHtml } from "./_lib/agenda-email.js";
...
export default async function handler(req, res) {
  ...
  try {
    const { title, dateFormatted, topics, openFloor, lastMeetingOverview, attendees } = req.body;
    ...
    const subject = `${title} · Meeting Agenda for ${dateFormatted}`;
    ...
    console.error("POST /api/meetings/send-prep error:", err);
